...
I think we should include the code in the book, since readers may not have Internet access while they read it (they might be on a plane, at the beach, etc.)
